...
INFO "OVIS_REPO: ${OVIS_REPO}"
INFO "OVIS_BRANCH: ${OVIS_BRANCH}"
INFO "SOS_REPO: ${SOS_REPO}"
INFO "SOS_BRANCH: ${SOS_BRANCH}"
INFO "MAESTRO_REPO: ${MAESTRO_REPO}"
INFO "MAESTRO_BRANCH: ${MAESTRO_BRANCH}"
